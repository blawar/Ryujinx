...
#pragma warning disable CS0649, IDE0044
        ...
        [Builder.Object] Box         _availableUpdatesBox;
        [Builder.Object] RadioButton _noUpdateRadioButton;
        [Builder.Object] Button      _addUpdate;
        [Builder.Object] Button      _removeUpdate;
        [Builder.Object] Button      _saveButton;
        [Builder.Object] Button      _cancelButton;
#pragma warning restore CS0649, IDE0044

        public TitleUpdateWindow(GtkUserInterface gtkUserInterface, string titleId, string titleName, VirtualFileSystem virtualFileSystem) 
            : this(new Builder("Ryujinx.Ui.TitleUpdateWindow.glade"), gtkUserInterface, titleId, titleName, virtualFileSystem) { }

        private TitleUpdateWindow(Builder builder, GtkUserInterface gtkUserInterface, string titleId, string titleName, VirtualFileSystem virtualFileSystem) 
            : base(builder.GetObject("TitleUpdateWindow").Handle)
        {
            builder.Autoconnect(this);

            _addUpdate.Clicked    += AddButton_Clicked;
            _removeUpdate.Clicked += RemoveButton_Clicked;
            ...
            foreach ((RadioButton button, string selected) in _radioButtonToPathDictionary)
            {
                if (selected == _titleUpdateWindowData.Selected)
                {
                    button.Active = true;
                }
            }
            ...
            using (FileStream file = new FileStream(path, FileMode.Open, FileAccess.Read))
            {
                ...
                foreach (DirectoryEntryEx fileEntry in nsp.EnumerateEntries("/", "*.nca"))
                {
                    ...
                    try
                    {
                        ...
                        {
                            _gtkUserInterface.ShowErrorDialog("The specified file does not contain an update for the selected title!");
                    ...
                    catch (InvalidDataException exception)
                    {
                        ...
                        if (showErrorDialog)
                        {
                            _gtkUserInterface.ShowInfoDialog("Add Update Failed!", "The NCA header content type check has failed. This is usually because the header key is incorrect or missing.");
                        }
                    ...
                    catch (MissingKeyException exception)
                    {
                        ...
                        if (showErrorDialog)
                        {
                            _gtkUserInterface.ShowInfoDialog("Add Update Failed!", $"Your key set is missing a key with the name: {exception.Name}");
                        }
        ...
        private void SaveButton_Clicked(object sender, EventArgs args)
        {
            ...
            _gtkUserInterface.InvokeRefreshTitleListEvent();
            Dispose();
        }
    }
}